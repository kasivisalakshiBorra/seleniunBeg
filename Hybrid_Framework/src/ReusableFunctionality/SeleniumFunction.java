...
import TexAcademyExecute.TexAcademyRun;
 
 
public class SeleniumFunction extends TestSteps{
...
/////////////////////////////////////////Save Text by using name///////////////////////             
                ...
                public static void DropSelectbyName(String objects, String description,
                                                String testData) {
                                try{
                                String runtimeText = "";
                                int count = driver.findElements(By.name(objects)).size();
                                if (count == 1) {
                                                new Select(driver.findElement(By.name(objects))).selectByVisibleText(testData);        
                                                Report.pass("Dro down selected successfully " + testData, objects,
                                                        testData);
                                } else {
                                                Report.fail(description + " Object not available", objects,
